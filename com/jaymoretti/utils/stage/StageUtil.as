...
package com.jaymoretti.utils.stage
{
	...
	public class StageUtil
	{
		...
		private static var _minStageHeight : Number;
		private static var _minStageWidth : Number;

		public static function init(stageObject : Stage, minStageWidth:Number = 1000, minStageHeight:Number = 700) : void
		{
			_stage = stageObject;
			...
			_minStageWidth = minStageWidth;
			_minStageHeight = minStageHeight;
		}
		...
		{
			if (_stage.stageHeight > _minStageHeight && _stage.stageWidth > _minStageWidth)
			{
				_stage.dispatchEvent(new StageEvent(StageEvent.RESIZE));
			}
		}

		public static function set minStageHeight(maxHeight : Number) : void
		{
			_minStageHeight = maxHeight;
		}

		public static function set minStageWidth(maxWidth : Number) : void
		{
			_minStageWidth = maxWidth;
		}
